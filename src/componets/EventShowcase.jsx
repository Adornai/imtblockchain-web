...
import eventImage from "../assets/image9.jpg"; 
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 sm:gap-20">
          ...
          >
            ...
            <a href="https://x.com/IMTBlockChain/status/1954861144784470211?s=20" target="_blank"><div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <img 
                src={eventImage} 
              ...
              <div className="absolute bottom-4 left-4 bg-black/70 backdrop-blur-md px-4 py-2 rounded-lg border border-white/10">
                <p className="text-blue-400 text-sm font-bold">ETH Enugu 2025</p>
              </div>
            </div></a>
          </motion.div>
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Empowering the Next Gen at <span className="text-blue-500">ETH Enugu</span>
            </h2>
            ...
            <p className="text-gray-100 text-lg leading-relaxed mb-6 font-Jost">
              ...
              <span className="text-white font-semibold"> ETH Enugu</span>. 
