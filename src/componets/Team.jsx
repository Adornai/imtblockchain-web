...
const Team = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative group w-full h-[450px] rounded-2xl overflow-hidden cursor-pointer shadow-lg border border-white/5"
    >
      ...
      {/* 2. GRADIENT OVERLAY */}
      <a href={link} target="blank"></a><div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/60 to-transparent opacity-90 transition-opacity duration-300"></div>
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
        ...
        <h1 className='text-5xl font-bold text-center text-white'>Our <span className='text-blue-500'>Teams</span></h1>
        <div>
            <div className='bg-red-500 w-50 h-70'></div>
            <div className='bg-blue-500 w-50 h-70'></div>
            <div className='bg-yellow-500 w-50 h-70'></div>
